...
public class SpringBookBeans {
    ...
    @Bean
    public BookQueryHandler bookQueryHandler(BookRepository bookRepository, BookReviewRepository bookReviewRepository) {
        return new BookQueryHandler(bookRepository, bookReviewRepository);
    }
